# Generated by Django 4.1.3 on 2023-02-26 03:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='municipio_lista',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('municipio', models.CharField(max_length=50)),
                ('departamento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.departamento_lista')),
            ],
        ),
        migrations.AddField(
            model_name='familia',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Departamento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.departamento_lista')),
                ('Municipio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.municipio_lista')),
            ],
        ),
        migrations.AddField(
            model_name='clase',
