...
class especimen(models.Model):
    ...
    NombreDelConjuntoDatos = models.CharField(max_length=500,null=True, blank=True, default=None)
    ComentarioRegistroBiologico = models.CharField(max_length=500,null=True, blank=True, default=None)
    RegistradoPor = models.CharField(max_length=500,null=True, blank=True, default=None)
    NumeroIndividuo = models.CharField(max_length=500,null=True, blank=True, default=None)
    ...
    IdentificadoPor= models.CharField(max_length=500,null=True, blank=True, default=None)
    FechaIdentificacion = models.DateField(max_length=500,null=True, blank=True, default=None)
    IdentificacionReferencias = models.CharField(max_length=500,null=True, blank=True, default=None)
    ComentarioIdentificacion = models.CharField(max_length=500,null=True, blank=True, default=None)
    NombreCientificoComentarioRegistroBiologico = models.CharField(max_length=500,null=True, blank=True, default=None)
